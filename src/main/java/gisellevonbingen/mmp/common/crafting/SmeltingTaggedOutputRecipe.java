...
public class SmeltingTaggedOutputRecipe extends SmeltingRecipe implements ITaggedOutputRecipe, ISingleIngredientRecipe
{
	...
	public SmeltingTaggedOutputRecipe(String pGroup, CookingBookCategory pCategory, Ingredient pIngredient, ItemStackIngredient output, float pExperience, int pCookingTime)
	{
	...
	{
		return MMPRecipeSerializers.TAG_SMELTING.get();
	}
